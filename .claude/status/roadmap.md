...
| 8a | ~~Macro Workbench M-1 — Signal layer~~ | ✅ shipped 2026-04-30 ([macro.md](../modules/macro.md), [decisions/012](../decisions/012-macro-workbench-storage-shape.md)) | — |
| 8b | ~~Macro Workbench M-2 — Hypothesis object + view registry~~ | ✅ shipped 2026-05-01 ([hypotheses.md](../modules/hypotheses.md), [views.md](../modules/views.md), [decisions/013](../decisions/013-hypothesis-object.md)) | — |
| 8b.1 | ~~Phase 2 — Vault + indexer sidecar~~ | ✅ shipped 2026-05-02 ([vault.md](../modules/vault.md), [decisions/014](../decisions/014-vault-indexer.md)) | — |
| 8b.2 | ~~Phase 3 — Stress-test endpoint~~ | ✅ shipped 2026-05-02 ([research.md](../modules/research.md), [decisions/015](../decisions/015-research-stress-test.md)) | — |
...
| 8b.8 | ~~Phase 3.7 — Research UI v1 (single-turn)~~ | ✅ shipped 2026-05-02 ([research.md](../modules/research.md), plan: [plans/phase-3.7-research-ui-single-turn.md](../plans/phase-3.7-research-ui-single-turn.md)) | — |
...
(Same ones as last sprint; see [principles.md](../guides/principles.md) for the full list.)
...
1. Read [principles.md](../guides/principles.md) — confirm the new phase doesn't violate them.
