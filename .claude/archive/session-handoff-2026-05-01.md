...
| M-3..M-6 Macro Workbench | Candidates in roadmap | [.claude/roadmap.md](../status/roadmap.md) |
| 12-month hypothesis re-evaluation | Backlog item; first reviews due 2027-04-30 | [.claude/backlog.md](../status/backlog.md) |
...
Schema sketched in [.claude/macro-workbench-brainstorm.md](../plans/macro-workbench-brainstorm.md). M-2 implements: `slug`, `parent_id`, `precondition_id`, `claim_type`, `primary_metric`, `tracking_signal`, lifecycle status (`active|confirming|violated|stale|cancelled`), TTL auto-deprecate, manual cancel.
