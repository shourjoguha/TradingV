...
> **Related:** [roadmap.md](roadmap.md), [opportunities.md](opportunities.md), [trades.md](trades.md), [predictions.md](predictions.md).
...
- Roadmap candidate added in [roadmap.md](roadmap.md) as item M-1.
