...
LOOPS: dict[str, LoopMeta] = {
    "accuracy": LoopMeta(
        ...
        description="Daily: fills prediction_accuracy after end-of-day OHLCV ingest.",
    ...
    "drift": LoopMeta(
        ...
        description="Daily: flags pairs where recent MAPE has degraded.",
        default_cadence_seconds=DAY,
        supports_abort=True,
        confirm_modal_required=False,
        cost_sensitive=False,
    ...
    "opps": LoopMeta(
        ...
        description="Daily: rule engine over recent predictions (or manual fire).",
        default_cadence_seconds=DAY,
        supports_abort=True,
        confirm_modal_required=False,
        cost_sensitive=False,
    ...
    "video_ingest": LoopMeta(
        ...
        description="Daily poll of every Videos/<channel>/_channel.yaml.",
        default_cadence_seconds=DAY,
        supports_abort=True,
        confirm_modal_required=False,
        cost_sensitive=False,
    ...
    "edgar_ingest": LoopMeta(
        ...
        description="Weekly: poll roster tickers for 8-K / 10-Q / 10-K.",
        default_cadence_seconds=7 * DAY,
        supports_abort=True,
        confirm_modal_required=False,
        cost_sensitive=False,
    ...
    "tv_context_expire": LoopMeta(
        ...
        description="12-hourly (laptop) / daily (Railway): drops expired payloads.",
        default_cadence_seconds=12 * HOUR,
        supports_abort=True,
        confirm_modal_required=False,
        cost_sensitive=False,
        default_enabled=True,
    ...
    "sync_drain": LoopMeta(
        ...
        description="5-min batch push of pending outbox rows to peer. Disabled by default since 2026-05-16 (Railway shut); set SYNC_ENABLED=true + peer creds to re-enable.",
